...
public interface BasicSchoolInforService{
	 ...
	 * @return
	 */
    int updateBasicSchoolInfor(BasicSchoolInfor value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBasicSchoolInfor(BasicSchoolInfor value, Assist assist);
}