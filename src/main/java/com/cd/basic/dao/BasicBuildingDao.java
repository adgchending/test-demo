...
public interface BasicBuildingDao{
	 ...
	 * @return
	 */
    int updateBasicBuilding(@Param("enti") BasicBuilding value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBasicBuilding(@Param("enti") BasicBuilding value, @Param("assist") Assist assist);
}
